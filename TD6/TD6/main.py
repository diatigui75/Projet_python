...
corpus_charge.stats(n=10)  # Affiche les statistiques sur le corpus chargé
resultats_recherche = corpus_charge.search("Python")  # Recherche un mot-clé
print("\nRésultats de la recherche pour 'Python' :", resultats_recherche)
concordancier = corpus_charge.concorde("Python", taille_contexte=20)  # Construit un concordancier
